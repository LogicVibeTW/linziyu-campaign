...
export const policies = [
  {
    id: "01",
    title: "人行道淨空行動",
    text: "清查並移除人行道上不當放置的車擋、盆栽等障礙物，還給行人、輪椅與嬰兒車真正能安全通行的空間。",
  },
  {
    id: "02",
    title: "捷運周邊停車整頓",
    text: "盤點捷運站周邊 500 公尺內停車格配置，改善違停與規劃不足的亂象，讓通勤族騎車、停車不再一位難求。",
  },
  {
    id: "03",
    title: "親子交通示範公園",
    text: "選定合適公園打造交通情境教學空間，讓孩子從小認識號誌與行的安全，寓教於樂。",
  },
];
